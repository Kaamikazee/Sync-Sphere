...
export const getGroups = async (userId: string) => {
  const res = await fetch(
    `${baseUrl}/api/group/user_groups/?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getGroupWithSubscribers = async (
  group_id: string,
  userId: string
) => {
  const res = await fetch(
    `${baseUrl}/api/group/get/subscribers/${group_id}?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getUserPomodoroSettings = async (userId: string) => {
  const res = await fetch(
    `${baseUrl}/api/pomodoro/get_settings?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getActivities = async (userId: string) => {
  const res = await fetch(
    `${baseUrl}/api/activity/user_activities?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getAnnouncements = async (groupId: string) => {
  const res = await fetch(
    `${baseUrl}/api/announcement/get?groupId=${groupId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getAnnouncementDetail = async (announcementId: string) => {
  const res = await fetch(
    `${baseUrl}/api/announcement/get/detail?announcementId=${announcementId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getSubscribersWithTotalSeconds = async (group_id: string) => {
  const res = await fetch(
    `${baseUrl}/api/simple_timer/get?groupId=${group_id}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getFocusAreaTotals = async (userId: string) => {
  const res = await fetch(
    `${baseUrl}/api/focus_area/get/totals?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getGroupIdAndSubscribers = async (userId: string) => {
  const res = await fetch(
    `${baseUrl}/api/group/user_groups/subscribers?userId=${userId}`,
    {
      method: "GET",
      cache: "no-store",
    }
...
export const getAllGroups = async () => {
  const res = await fetch(`${baseUrl}/api/group/all-groups`, {
    method: "GET",
    cache: "no-store",
  });
  ...
  return res.json() as Promise<AllGroups[]>;
};
