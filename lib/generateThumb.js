// lib/attachments/generateThumb.js
...
export async function generateThumbnailForAttachment(attachmentId) {
  ...
  if (!att.mime || !att.mime.startsWith('image/')) return { ok: false, reason: 'not image' };
