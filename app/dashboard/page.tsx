          ...
          <Link href="/dashboard/timer" className="group">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Live Timer</h3>
                <p className="text-white/80">Track your focus sessions in real time.</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/dashboard/groups" className="group">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-white/80">Manage and join your focus groups.</p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/dashboard/todos" className="group">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Todos</h3>
                <p className="text-white/80">
                  Plan and track tasks — sync them with your focus sessions.
                </p>
              </div>
            </div>
          </Link>
