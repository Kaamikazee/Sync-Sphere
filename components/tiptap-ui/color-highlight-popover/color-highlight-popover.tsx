...
export const DEFAULT_HIGHLIGHT_COLORS: ColorHighlightPopoverColor[] = [
  ...
  {
    label: "Crimson",
    value: "var(--tt-color-highlight-crimson)",
    border: "var(--tt-color-highlight-crimson-contrast)",
  },
  {
    label: "Electric Blue",
    value: "var(--tt-color-highlight-electric-blue)",
    border: "var(--tt-color-highlight-electric-blue-contrast)",
  },
  {
    label: "Neon Green",
    value: "var(--tt-color-highlight-neon-green)",
    border: "var(--tt-color-highlight-neon-green-contrast)",
  },
  {
    label: "Dark Cyan",
    value: "var(--tt-color-highlight-dark-cyan)",
    border: "var(--tt-color-highlight-dark-cyan-contrast)",
  },
  {
    label: "Deep Violet",
    value: "var(--tt-color-highlight-deep-violet)",
    border: "var(--tt-color-highlight-deep-violet-contrast)",
  }
];
