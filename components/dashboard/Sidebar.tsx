...
const Sidebar = () => {
  ...
  // This handler checks if a click is outside both the sidebar and the toggle button.
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex justify-end cursor-pointer text-gray-500 hover:text-gray-900">
            <X size={18} onClick={() => setToggle(true)}/>
        </div>
